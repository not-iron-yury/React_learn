...
export const Posts = () => {
  ...
  const [totalPages, setTotalPages] = useState(0);    // общее количество страниц (всего постов / лимит)
  const [limit, setLimit] = useState(10);     // лимит постов на странице (передаем в PostsList.getAll)
  const [page, setPage] = useState(1);        // номер текущей страницы (передаем в PostsList.getAll)
  ...
  return (
      <section className="content">
        ...
        <div className="container">
          <h1 className="content__title">Список анонсов статей</h1>
